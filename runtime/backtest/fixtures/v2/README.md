...
| `DRSFRMACBS.csv` | Delinquency rate on one- to four-family residential loans, all commercial banks, seasonally adjusted, percent | Federal Reserve CHGDEL release, residential column (the series FRED publishes as `DRSFRMACBS`). Downloaded 2026-09-26. Quarter-end dates are stored as the quarter-start month. Last print: 1.86 on 2026-04-01 (2026 Q2). |
| `DRCCLACBS.csv` | Delinquency rate on consumer credit card loans, all commercial banks, seasonally adjusted, percent | Same CHGDEL release, credit-card column (FRED `DRCCLACBS`, issue #48). Last print: 2.85 on 2026-04-01 (2026 Q2). |
