...
## **How It Works**
The BugOut Index is **calculated daily** using **real-time data sources** to ensure accuracy and relevancy. The BOI aggregates multiple key indicators and normalizes them to a 0-100 scale, weighting them based on their impact on stability. These include:
- **Economic Factors:** Inflation, unemployment, and debt-to-GDP ratio.
- **Crime & Public Safety:** Crime rate trends and law enforcement data.
- **Social Stability:** Homelessness rates and institutional trust levels.

Each of these metrics is weighted and combined into a single **composite score**, which represents the overall **stability or instability** of a given society.
...
Each metric is **normalized** to a common scale and **weighted** based on its impact on stability.
...
- **Additional Indicators** (energy grid stability, food security).
- **Automation Enhancements** (more frequent real-time updates).
